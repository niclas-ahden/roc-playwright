...
## Test: tap! triggers a touch event on a button
...
main! = |_args|
    TestEnvironment.with!(|worker_url|
        ...
        Assert.eq(initial_text, "Not tapped yet") ? InitialStateShouldMatch
        ...
        Assert.eq(after_text, "Button was tapped!") ? AfterTapShouldMatch
