...
## Test: bounding_box! on display:none element times out
## Elements with display:none are attached to the DOM but not visible,
## so wait_for_selector! (which waits for "visible" state) will timeout.
