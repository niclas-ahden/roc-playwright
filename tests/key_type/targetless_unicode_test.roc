...
main! = |_args| {
    ...
    # Type unicode characters (accented letters, symbols)
    Playwright.key_type_targetless!(page, "Héllo Wörld!")?

    # Verify the input has the typed text including unicode
    value = Playwright.input_value!(page, "#name-input")?
    Assert.eq(value, "Héllo Wörld!") ? |e| UnicodeShouldBeTyped(e)
