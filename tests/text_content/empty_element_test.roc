...
main! = |_args| {
    ...
    # text_content! on empty element returns empty string
    empty_div_text = Playwright.text_content!(page, "#empty-div")?
    Assert.eq(empty_div_text, "") ? |e| EmptyDivShouldBeEmptyString(e)
