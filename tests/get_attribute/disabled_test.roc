...
main! = |_args| {
    ...
    # Boolean attribute returns empty string when present
    disabled = Playwright.get_attribute!(page, "#disabled-btn", "disabled")?
    Assert.eq(disabled, "") ? |e| DisabledShouldBeEmptyString(e)
