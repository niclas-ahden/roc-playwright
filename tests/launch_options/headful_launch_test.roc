...
main! = |_args|
    match Env.var_str!(OsStr.from_str("CI")) {
        ...
        Err(_) => {
            ...
            { browser, page } = Playwright.launch_page_with!(hooks, { browser_type: Chromium(DefaultChannel), headless: Bool.False, timeout: TimeoutMilliseconds(10000), args: [], has_touch: Bool.False, permissions: [] })?
